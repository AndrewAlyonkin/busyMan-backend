...
public class TaskTestData {
    ...
    public final static Task taskOne11 = new Task(11, new User(1), "Buy beer", 1, LocalDateTime.parse("2018-04-29T15:27:11"), new Priority(7), new Category(3));
    public final static Task taskOne12 = new Task(12, new User(1), "World var", 1, LocalDateTime.parse("2019-04-30T09:38:39"), new Priority(8), null);
    public final static Task taskOne13 = new Task(13, new User(1), "Pray to doshirak gods", 0, LocalDateTime.parse("2020-04-27T15:27:34"), new Priority(7), new Category(4));
    public final static Task taskOne14 = new Task(14, new User(1), "Kill Bill", 0, LocalDateTime.parse("2021-04-27T15:27:34"), new Priority(8), new Category(4));
    public final static Task taskTwo15 = new Task(15, new User(2), "Make my cat bold", 1, LocalDateTime.parse("2018-04-28T07:03:03"), new Priority(9), null);
    public final static Task taskTwo16 = new Task(16, new User(2), "Make my dog longhair", 1, LocalDateTime.parse("2019-04-28T07:03:03"), new Priority(10), null);
    public final static Task taskTwo17 = new Task(17, new User(2), "Ride a car", 0, LocalDateTime.parse("2020-05-06T09:38:23"), new Priority(9), new Category(5));
    public final static Task taskTwo18 = new Task(18, new User(2), "Keep calm", 0, LocalDateTime.parse("2021-05-01T12:01:18"), new Priority(10), new Category(6));
